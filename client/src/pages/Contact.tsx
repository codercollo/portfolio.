...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d] text-white">
      {/* Hero Section */}
      <section className="relative py-24 md:py-36 px-6 md:px-12 lg:px-16 bg-[#0d0d0d] overflow-hidden text-center">
        {/* Background Blobs */}
      ...
      <section id="contact-form" className="py-24 md:py-36 px-6 md:px-12 lg:px-16 flex justify-center">
        <form
          onSubmit={handleSubmit}
          className="w-full max-w-xl bg-[#1a1a1a] p-10 md:p-12 rounded-3xl shadow-lg space-y-6 relative z-10"
        >
          ...
          <label className="block">
            ...
            <input
              ...
              required
              className="mt-2 w-full px-5 py-4 bg-[#0d0d0d] border-2 border-[#2d2d2d] text-white rounded-lg focus:border-[#00ff88] transition-all"
            />
          </label>
          ...
          <label className="block">
            ...
            <textarea
              ...
              disabled={status === "sending"}
              required
              className="mt-2 w-full px-5 py-4 bg-[#0d0d0d] border-2 border-[#2d2d2d] text-white rounded-lg resize-none focus:border-[#00ff88] transition-all"
            />
          </label>
